...
})()(
  {
    ...
    5: [
      function (require, module, exports) {
        ...
        // Input fields
        const starting_station_input_field = document.getElementById(
          "sStation"
        );
        ...
        const l_when_board = document.getElementById("l_when_board");
        ...
        function requestData(opcodein, starting_staiton = "") {
          socket.emit("server-gateway", {
            opcode: opcodein,
            station_name: starting_staiton,
          });
        }
          ...
          if (id === starting_station_input_field.id) {
            ...
            if (starting_station_verified) {
              requestData(
                ...
                starting_station_input_field.value
              );
            } else clearInfo();
    ...
    14: [
      ...
      { "component-emitter": 8, "engine.io-parser": 26 },
    ],
    15: [
      function (require, module, exports) {
      ...
      {
        "../../contrib/xmlhttprequest-ssl/XMLHttpRequest": 22,
        "./polling-jsonp": 16,
        "./polling-xhr": 17,
        "./websocket": 20,
      },
    ...
    24: [
      ...
      { "./commons": 23, "base64-arraybuffer": 7 },
    ],
    25: [
      function (require, module, exports) {
    ...
    26: [
      ...
      { "./decodePacket": 24, "./encodePacket": 25 },
    ],
    27: [
      function (require, module, exports) {
        /**
    ...
    34: [
      ...
      { "./on": 33, "./typed-events": 35, debug: 9, "socket.io-parser": 38 },
    ],
    35: [
      function (require, module, exports) {
        "use strict";
    ...
    38: [
      ...
      { "./binary": 37, "./is-binary": 39, "component-emitter": 8, debug: 9 },
    ],
    39: [
      function (require, module, exports) {
        "use strict";
